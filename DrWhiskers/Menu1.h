...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Location = System::Drawing::Point(78, 50);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(222, 112);
			this->button1->TabIndex = 0;
			this->button1->Text = L"Start Debugging";
			...
			this->button2->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(64)),
				static_cast<System::Int32>(static_cast<System::Byte>(0)));
			this->button2->Location = System::Drawing::Point(78, 224);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(222, 112);
			this->button2->TabIndex = 1;
			this->button2->Text = L"Debugging Skills";
			...
			this->pictureBox1->Size = System::Drawing::Size(405, 487);
			...
			this->ClientSize = System::Drawing::Size(378, 418);
...
#pragma endregion
		//Links to Assistant Window
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		this->Hide();
		Assistant^ assistant = gcnew Assistant();
		assistant->Show();
	}
		 //Links to Skills Window
